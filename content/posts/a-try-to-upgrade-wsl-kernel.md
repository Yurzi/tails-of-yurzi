...
lastmod: "2025-09-01T14:48:32+08:00"
author: ["Yurzi", "Lily"]
...
总所周知，「鹅」（dae）[^1]是一款基于 eBPF 的透明代理工具，
...
但出于一些原因回退到了现在的版本，
在 WSL2 内核的官方仓库[^2]中可以看到新版内核的 Release。
...
就是将那些被移除的模块重新内联。其中一位大佬给出了一份config[^6]。

将这份配置稍加修改以满足当前系统和编译器的要求，同时遵循的这篇博客[^5]开启 eBPF。
然后就可以重新编译新的内核并安装。
...
[^1]: [Github: daeuniverse/dae](https://github.com/daeuniverse/dae)
[^2]: [Github: Microsoft/WSL2-Linux-Kernal](https://github.com/microsoft/WSL2-Linux-Kernel)
[^3]: [Microsoft Learn: How to use the Microsoft Linux kernel v6 on Windows Subsystem for Linux version 2 (WSL2)](https://learn.microsoft.com/en-us/community/content/wsl-user-msft-kernel-v6)
[^4]: [Github Issue: docker cannot start after installing linux-msft-wsl-6.6.y](https://github.com/microsoft/WSL/issues/11742)
[^5]: [Massoud Asadi Blog: eBPF on WSL2 \[kernel version 6.x\] \[ubuntu\] \[x64\] \[Arm64\] \[2024\]](https://massoudasadiblog.blogspot.com/2024/07/ebpf-on-wsl2-kernel-version-6x-ubuntu.html)
[^6]: [Github Gist: eapotapov/config-wsl](https://gist.github.com/eapotapov/e64d8ce1d35064cf0dcd0dcd57577bdf">}}
